...
module.exports = {
    entry: {
        vendor: ['vue/dist/vue.esm.js', 'vue-router', 'vuex', 'vue-lazyload', 'axios', 'better-scroll', 
        'create-keyframe-animation', 'fastclick', 'good-storage', 'js-base64', 'jsonp', 'lyric-parser']
    },
    output: {
